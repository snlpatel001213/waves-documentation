...
3. Create [dApp script](/ride/script/dapp-script.md) with the `vote` method.
...
Create a [dApp script](/ride/script/dapp-script.md) by selecting **DApp** in the drop-down list.
