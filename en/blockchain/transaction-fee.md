...
| Mass transfer transaction | 11 | 0.001 + 0.0005 × N | `N` is the number of transfers inside of the transaction. The value of 0.0005 × N is rounded up to the thousandths. Therefore, 0.0005 × 1 = 0.001, 0.0005 × 2 = 0.001, and 0.0005 × 3 = 0.002 |
