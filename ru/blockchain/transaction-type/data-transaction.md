...
Для вычисления максимальной длины ключа он преобразуется в кодировку [UTF-16](https://ru.wikipedia.org/wiki/UTF-16). Размер получившегося массива 16-битных слов не может превышать 100 элементов. Таким образом, длина ключа может составлять от 1 до 200 байтов.
