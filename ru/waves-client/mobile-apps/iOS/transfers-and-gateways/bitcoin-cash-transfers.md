...
**Минимальная сумма пополнения 0.01 BCH**
```
Если вы отправите меньше, чем  0.01 BCH, вы потеряете деньги.
```
...
В появившемся окне вы найдете Bitcoin Cash адрес, который привязан к вашему Waves аккаунту.
...
* в строке **Ассет** Выберите **Bitcoin Cash**;
...
Пожалуйста, помните, что комиссия шлюза за обработку транзакции составляет **0.01 BCH**, а комиссия сети Waves - **0.001 Waves**.
