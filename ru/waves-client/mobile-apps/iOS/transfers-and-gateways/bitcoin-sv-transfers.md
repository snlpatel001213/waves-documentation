...
В появившемся окне в строке **Ассет** выберите **Bitcoin SV**.

![](/waves-client/mobile-apps/_assets/bitcoin-sv_01.png)

Перед следующем шагом, пожалуйста, внимательно прочитайте условия:

**Минимальная сумма пополнения 0.1 BSV**
```
Если вы отправите меньше, чем  0.1 BSV, вы потеряете деньги.
```
...
В появившемся окне вы найдете Bitcoin SV адрес, который привязан к вашему Waves аккаунту.
...
* в строке **Ассет** выбирете **Bitcoin SV**;
* в строку **Получатель** введите Bitcoin SV адрес получателя или сканируйте QR-код или найдите адрес получателя в **Адресной книге**;
* в строку **Количество** сумму Bitcoin SV, которую вы хотите отправить на Bitcoin SV адрес Получателя или выберите параметр из списка: **Весь баланс** **50%** **10%** **5%**.

Пожалуйста, помните, что комиссия шлюза за обработку транзакции составляет **0.01 BSV**, а комиссия сети Waves - **0.001 Waves**.
...
You can send Bitcoin SVs directly to another Waves account.
