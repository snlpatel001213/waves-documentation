...
3. Создадим [dApp-скрипт](/ride/ride-script/dapp-script.md) с методом `vote`.
...
Создайте [dApp-скрипт](/ride/ride-script/dapp-script.md), выбрав в выпадающем списке **DApp**.
